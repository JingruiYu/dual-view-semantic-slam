...
int main(int argc, char **argv)
{
    if(argc != 4)
    {
        cerr << endl << "Usage: ./mono_fisheye_bev path_to_vocabulary path_to_settings path_to_sequence" << endl;
        return 1;
    }
    ...
    SLAM.SaveKeyFrameTrajectoryOdomTUM("KeyFrameTrajectoryOdom.txt");
